...
const
  ...
  LIBTIEPIE_VERSION_MINOR = 8;
  LIBTIEPIE_VERSION_RELEASE = 2;
  LIBTIEPIE_VERSION_NUMBER = '0.8.2';

  LIBTIEPIE_VERSION = '0.8.2';
  LIBTIEPIE_REVISION = 13423;
  ...
  PID_125020VI = 33; // Virtual instrument 1250-20
  ...
  {$if defined( LINUX )}
  sLibTiePieFileNameDefault = 'libtiepie.so.0.8.2';
