...
#define LIBTIEPIE_VERSION_MINOR    8
#define LIBTIEPIE_VERSION_RELEASE  2
#define LIBTIEPIE_VERSION_NUMBER   "0.8.2"
#define LIBTIEPIE_VERSION          "0.8.2"
#define LIBTIEPIE_REVISION         13423
